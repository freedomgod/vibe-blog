...
_EXPORTS = {
    ...
    "init_search_service": ("services.blog_generator.services.search_service", "init_search_service"),
    "get_search_service": ("services.blog_generator.services.search_service", "get_search_service"),
